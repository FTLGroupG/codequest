...
export default function Home() {
  return (
    <div className='Home'>
        ...
        <img src='src/assets/robot.png' id="floating-robot" width="200px" className='floating'></img>
...
<div className='cardTextFloatRight'>
          ...
          <h2 className="pinkH2">Play games and learn how to code at the same time!</h2>
          <h3>CodeQuest is designed to give kids a fun and interactive environment to learning. Give it a try!</h3>
        </div>
        </div>
...
<h2>Want to try a lesson before signing up?</h2>
          <div className="pythonCard">
            <h3>Learn Python</h3>
            <h4>In this lesson, we will learn the basics about the Python coding language!</h4>
